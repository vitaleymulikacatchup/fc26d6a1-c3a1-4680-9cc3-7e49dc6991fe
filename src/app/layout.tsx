...
export const metadata: Metadata = {
  title: "AutoElite - Premium Vehicles & Expert Service",
  description: "Discover luxury and performance cars at AutoElite. Certified pre-owned and new vehicles with transparent pricing, flexible financing, and exceptional customer service.",
  keywords: "car dealership, luxury vehicles, certified pre-owned cars, auto financing, vehicle sales",
  metadataBase: new URL("https://autoelite-cars.com"),
  alternates: {
    canonical: "https://autoelite-cars.com"
  },
  openGraph: {
    title: "AutoElite - Your Perfect Vehicle Awaits",
    description: "Browse premium vehicles with competitive pricing and expert guidance. Schedule your test drive today.",
    url: "https://autoelite-cars.com",
    siteName: "AutoElite",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35vmIsFKiMtTSUSBP7nWGRgR0We/uploaded-1765885724057-c52aabbi.jpg",
  ...
  twitter: {
    ...
    title: "AutoElite - Premium Vehicles",
    description: "Discover luxury and performance cars with expert service.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35vmIsFKiMtTSUSBP7nWGRgR0We/uploaded-1765885724057-c52aabbi.jpg"]
  },
  robots: {
    index: true,
    follow: true
